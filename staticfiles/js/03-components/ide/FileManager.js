 ...
 * FileManager.js
 * 
 * Obsidian-like file manager with folder collapsing, file selection,
 * keyboard shortcuts, and multi-selection support.
 */
...
class FileManager {
    constructor(containerSelector, options = {}) {
        ...
        this.files = new Map(); // file id -> file data
    ...
    toggleFolder(folderElement) {
        ...
        if (isExpanded) {
            // Collapse - use CSS classes for smooth transition
            ...
            // Expand - remove collapsed class and show immediately
    ...
    ensureRootFoldersExpanded() {
        ...
        rootFolders.forEach(folder => {
            ...
            // Ensure the folder name has the expanded class and content is not collapsed
    ...
    applyExpandedState() {
        ...
        // Apply collapsed state to non-expanded folders
